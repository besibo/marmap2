# Making and using bathymetric maps with marmap2
...
![](marmap2_files/figure-html/quickplot-1.png)
...
![](marmap2_files/figure-html/detailed-alboran-map-1.png)
...
palettes, or hand-made gradients. The extended website tutorial shows
several high-resolution palette variants on the same Alboran Sea grid.
...
The two maps below use a reduced Alboran grid. In truncate mode, Alboran
colours are anchored to the Mediterranean reference object. In rescale
mode, the full palette is used within the local depth range of the
Alboran Sea.
...
![](marmap2_files/figure-html/palette-alboran-truncate-1.png)
...
![](marmap2_files/figure-html/palette-alboran-rescale-1.png)
...
![](marmap2_files/figure-html/contour-only-1.png)
...
![](marmap2_files/figure-html/antimeridian-plot-1.png)
...
![](marmap2_files/figure-html/projection-map-1.png)
...
![](marmap2_files/figure-html/griddify-1.png)
