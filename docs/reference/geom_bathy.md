...
## Arguments
  ...
  - ...:
    ...
    between adjacent tiles. Tile width and height are also set from the
    grid spacing by default so the panel grid does not show through
...
`coord_sf_antimeridian`, `as_sf`, `bathy_to_tbl`
