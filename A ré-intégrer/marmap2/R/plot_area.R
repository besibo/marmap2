...
#' @usage
#' plot_area(area, col)
#' @param area a list of 4 elements as produced by \code{\link{get_area}}.
...
#'
#' @seealso
#' \code{\link{get_area}}, \code{\link{plot_bathy}}, \code{\link[geosphere]{areaPolygon}}
#'
#' @examples
...
#' @export
plot_area <- function(area, col) {
  if (!is.list(area)) stop("'area' must be a ist of 4 elements as produced by 'get_area()'")
