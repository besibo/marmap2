...
#' @rdname get_transect
#' @usage
#' get_transect(mat, x1, y1, x2, y2, locator=FALSE, distance=FALSE, \dots)
...
#'
#' @details
#' \code{get_transect} allows the user to compute an approximate linear depth cross section either by inputing start and stop coordinates, or by clicking on a map created with \code{plot_bathy}. In its interactive mode, this function uses the \code{locator} function (\code{graphics} package); after creating a map with \code{plot_bathy}, the user can click twice to delimit the bound of the transect of interest (for example, lower left and upper right corners of a rectangular area of interest), press Escape, and get a table with the transect information.
#'
#' @return
...
#'
#' @seealso
#' \code{\link{read_bathy}}, \code{\link{nw.atlantic}}, \code{\link{nw.atlantic.coast}}, \code{\link{get_depth}}, \code{\link{get_sample}}
#'
#' @examples
#' # load datasets
...
#' 	}
#' @export
get_transect = function(mat, x1, y1, x2, y2, locator=FALSE, distance=FALSE,...){
