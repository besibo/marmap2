...
#' @rdname plot_profile
#' @usage
#' plot_profile(profile,shadow=TRUE,xlim,ylim,col.sea,col.bottom,xlab,ylab, \dots)
#' @param profile 4-columns matrix obtained from \code{get_transect} with argument \code{dist=TRUE}, or from \code{path_profile}.
...
#'
#' @seealso
#' \code{\link{path_profile}}, \code{\link{plot_bathy}}
#'
#' @examples
#' # Example 1:
#' 	data(celt)
...
#' }
#' @export
plot_profile <- function(profile,shadow=TRUE,xlim,ylim,col.sea,col.bottom,xlab,ylab,...){
