...
#'
#' @details
#' \code{least_cost_distance2} computes least cost distances between 2 or more locations. This function relies on the package \code{gdistance} (van Etten, 2011. \url{https://CRAN.R-project.org/package=gdistance}) and on the \code{transition_matrix} function to define a range of depths where the paths are possible.
#'
#' @return
...
#'
#' @seealso
#' \code{\link{transition_matrix}}, \code{\link{least_cost_distance}}
#'
#' @examples
