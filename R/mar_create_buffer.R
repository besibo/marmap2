...
#'
#' @rdname mar_create_buffer
#' @aliases print.buffer
#' @usage
#' mar_create_buffer(x, loc, radius, km = FALSE)
...
#'
#' @seealso
#' \code{\link{mar_outline_buffer}}, \code{\link{mar_combine_buffers}}, \code{\link{mar_plot_bathy}}
#'
#' @examples
...
#' @export
#' @aliases create.buffer
mar_create_buffer <- function(x, loc, radius, km=FALSE){
	...
	temp <- -mar_as_bathy(as(temp,'SpatialGridDataFrame'))
...
#' @rdname mar_create_buffer
#' @export
create.buffer <- mar_create_buffer
