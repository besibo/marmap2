...
#'
#' @description
#' \code{lines_gc} draws Great Circle lines between a set of start and end points on an existing map.
#'
#' @rdname lines_gc
#' @usage
#' lines_gc(start.points, end.points, n = 10, antimeridian = FALSE, \dots)
...
#' @export
lines_gc <- function(start.points, end.points, n = 10, antimeridian = FALSE, ...) {
