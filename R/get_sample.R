...
#' @rdname get_sample
#' @usage
#' get_sample(mat, sample, col.lon, col.lat, \dots)
...
#' }
#' @export
get_sample=function(mat, sample, col.lon, col.lat, ...){
