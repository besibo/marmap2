...
#'
#' @details
#' The use of \code{mar_as_bathy} and \code{mar_as_xyz} allows to swicth back and forth between the long format (xyz) and the wide format of class \code{bathy} suitable for plotting bathymetric maps, computing least cost distances, etc. \code{mar_as_xyz} is especially usefull for exporting xyz files when data are obtained using \code{mar_subset_sql}, i.e. bathymetric matrices of class \code{bathy}.
#'
#' @return
...
#'
#' @seealso
#' \code{\link{mar_as_bathy}}, \code{\link{mar_summary_bathy}}
#'
#' @examples
#' # load celt data
#' data(celt)
