...
#' Computes least cost distances between two or more locations
#'
#' @rdname mar_least_cost_distance
#' @usage
...
#'
#' @seealso
#' \code{\link{mar_transition_matrix}}
#'
#' @examples
...
#' @export
#' @aliases lc.dist
mar_least_cost_distance <- function(trans, loc, res = c("dist", "path"), meters = FALSE, round = 0) {
...
#' @rdname mar_least_cost_distance
#' @export
lc.dist <- mar_least_cost_distance
