...
#'
#' @rdname mar_distance_to_isobath
#' @usage
#' mar_distance_to_isobath(mat, x, y=NULL, isobath=0, locator=FALSE, \dots)
...
#'
#' @seealso
#' \code{\link{mar_lines_gc}}, \code{\link{mar_least_cost_distance}}
#'
#' @examples
...
mar_distance_to_isobath <- function(mat, x, y=NULL, isobath=0, locator=FALSE, ...) {
...
#' @rdname mar_distance_to_isobath
#' @export
dist2isobath <- mar_distance_to_isobath
