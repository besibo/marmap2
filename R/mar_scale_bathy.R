...
#'
#' @rdname mar_scale_bathy
#' @usage
#' mar_scale_bathy(mat, deg=1, x="bottomleft", y=NULL, inset=10, angle=90, ...)
#' @param mat bathymetric data matrix of class \code{bathy}, imported using \code{mar_read_bathy}
...
#' @export
#' @aliases scaleBathy
mar_scale_bathy = function (mat, deg=1, x="bottomleft", y=NULL, inset=10, angle=90, ...) {
